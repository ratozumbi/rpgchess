...
import boneco.AbstractChessPiece;
import boneco.King;
...
//		stalemateChecker.setPreviousNumberOfChessPieces(chessBoard.getNumberOfChessPieces());
		...
		gcState.currentPlayerToMove = Colour.WHITE;// (gcState.getCurrentPlayerToMove() == Colour.WHITE) ? Colour.BLACK : Colour.WHITE;
...
//		possibleMoves = cullIllegalMoves(initialPossibleMoves, chessPiece); <<<<<<<<<<<<<<<<<<<<<<<<<<<<<< ISSO PODE SER IMPORTANTE
